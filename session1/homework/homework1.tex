...
\begin{solution}
    ...
    As G is linearly dependent, no column can be a linear combination of other columns, except the zero vector. $G x$ is a linear combination x of the columns of G. Therefore $\nullspace(G)={0}$. Also, this implies that $G x \ne 0$ for any $x \ne 0$. Therefore, $d > 0$.
\end{solution}
